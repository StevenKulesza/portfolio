    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-content text-center">
                <div class="modal-header">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="70px" viewBox="0 0 100 68">
                        <g id="large">
                            <g transform="rotate(280.024 31 37)">
        ...
        c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="#E43"></path>
                            ...
                            <g id="small" transform="rotate(-60.0365 78 21)">
        ...
        C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#E43"></path>
                ...
                <h3 style="text-transform:uppercase; letter-spacing:2px;">Projects available soon.</h3>
                <em><a href="mailto:stevenn.kulesza@gmail.com">Email</a></em> or <em><a style="cursor:pointer;" data-dismiss="modal" aria-label="Close">Return</a></em>
            </div>
        </div>

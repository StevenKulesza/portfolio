                ...
                <div class="col-sm-2 text-center">
                    <a href="#top">
                        <div class="logo-wrapper">
                            <div class="logo">
                                <span class="sk"><!-- <img src="img/logo-circle.svg"> -->
									<svg class="svg-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 720 720.7" style="enable-background:new 0 0 720 720.7;" xml:space="preserve">
									  <style>
									.svg-logo {
									  fill: #FF4240;
									...
									.svg-logo:hover{
										...
										-web-kit-animation: scaleTo 1s infinite;
									}
									@keyframes pulse {
									  14.2% { fill: #FF4240 }
									  28.4% { fill: #53536F }
...
<!--                                 <span class="skSmall">steven kulesza</span> -->
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <svg id="triangle" viewBox="0 0 1421 300" preserveAspectRatio="none">
